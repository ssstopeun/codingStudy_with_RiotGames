...
public class MockServiceTest {
    ...
    @Test
    public void 챔피언이름을가져오면_무조건_베인을_리턴한다() {
        Champion champion = mock(Champion.class);
    ...
    public void shouldDothrowExceptionWhenChamionSetNameYasuo(){
        Champion champion = mock(Champion.class);
    ...
    @Test
    public void shouldDoneTimeRunForChampionArraySize() {
    ...
    @Test
    public void shouldMostTwoTimesForChampionGetName() {
        Champion champion = mock(Champion.class);
        champion.setName("조이");
        champion.setPosition("미드");
        champion.setHasSkinCount(3);
    ...
    @Test
    public void shouldMostThreeTimesForChampionGetName() {
        Champion champion = mock(Champion.class);
        champion.setName("조이");
        champion.setPosition("미드");
        champion.setHasSkinCount(3);
    ...
    public void ListTest() {
       ...
       champions.add(new Champion("엘리스","정글",2));
